 ...
 */
public class GroceryList extends Fragment implements View.OnClickListener{

    private ArrayList<String> groceryList;

    private GroceryList.Listener listener;
...
//    }
    ...
    public interface Listener {
        void goToFragGroceryListView();
        void goToFragScanView();
        void goToFragAddItemView();
        void goToSettings();
    }
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (context instanceof GroceryList.Listener) {
            listener = (GroceryList.Listener) context;
        } else {
